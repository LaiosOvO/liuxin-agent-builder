...
**Plans**: 7 plans (Plan 01/02/03/04 ✅ Done — Wave 3 首发完成 4/7 57%)
  ...
  - [x] 05a-05-PLAN.md — PlatformDaemonClient + capability_facades 真接 daemon + MockPlugin (Wave 4) — 2026-05-17 完成（11 测试 / PlatformDaemonClient JSONRPC over stdio + echo_daemon fixture / PLUG-FW-05 完成）
